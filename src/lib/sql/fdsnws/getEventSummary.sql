...
CREATE PROCEDURE getEventSummary(
  ...
  OUT out_alertlevel TEXT CHARACTER SET utf8,
  OUT out_review_status TEXT CHARACTER SET utf8,
  OUT out_event_type TEXT CHARACTER SET utf8,
  OUT out_azimuthal_gap DOUBLE,
  OUT out_magnitude_type TEXT CHARACTER SET utf8,
  OUT out_region TEXT CHARACTER SET utf8,
  OUT out_producttypes TEXT CHARACTER SET utf8,
  OUT out_eventids TEXT CHARACTER SET utf8,
  OUT out_eventsources TEXT CHARACTER SET utf8,
  OUT out_productsources TEXT CHARACTER SET utf8,
  OUT out_tsunami INT,
  OUT out_offset INT,
