Files in this directory set up mysql tables, view, stored procedures, and functions used by the FeedApp.
...
auto_summary.sql:
	...
	summarizes individual product properties in a separate table per product, with indexes.
