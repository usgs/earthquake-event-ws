...
';
$SIDE_NAVIGATION = dirname(__FILE__) . '/_navigation.inc.php';
include_once($_SERVER['DOCUMENT_ROOT'] . '/template/template.inc.php');

?>
<p>This is an implementation of the FDSN Event Web Service Specification, and allows custom searches for earthquake information using a variety of parameters.  Please note that <strong><a href="<?php echo $FEED_HOST . $FEED_PATH; ?>/geojson.php">automated applications should use Real-time GeoJSON Feeds for displaying earthquake information whenever possible</a></strong>, as they will have the best performance and availability for that type of information.</p>

<p><a href="http://www.fdsn.org/webservices/FDSN-WS-Specifications-1.0.pdf">FDSN Web Service Specification PDF</a>.</p>

<h2 id="url">URL</h2>
<p><?php echo $HOST_URL_PREFIX . $FDSN_PATH; ?>/[<a href="#methods">METHOD</a>[?<a href="#parameters">PARAMETERS</a>]]</p>
...
<dl>
	...
	<p><a href="#parameters">See the Parameters section for supported url parameters.</a></p>
	</dd>
...
<p>These parameters should be submitted as key=value pairs using the HTTP GET method and may not be specified more than once; if a parameter is submitted multiple times the result is undefined.</p>

<h3>Time</h3>
<p>All times use ISO8601 Date/Time format.  Unless a timezone is specified, UTC is assumed.  Examples:</p>
<dl>
...
<dl>
	...
	<dd>ISO8601 Date/Time, e.g. <?php echo str_replace("+00:00", "", gmdate("c")); ?>
		<br/><small>Default is NOW-<?php echo ($DEFAULT_MAXEVENTAGE/86400); ?> days</small>
	</dd>
	<dd>Limit to events on or after the specified start time.</dd>

	<dt id="endtime">endtime</dt>
	<dd>ISO8601 Date/Time, e.g. <?php echo str_replace("+00:00", "", gmdate("c")); ?></dd>
...
<h3>Location</h3>
<p>Requests that use both rectangle and circle will return the intersection, which may be empty, use with caution.</p>

<h4>Rectangle</h4>
<p>Requests may use any combination of these parameters.
<br/><small>min values must be less than max values.</small>
<br/><small>rectangles may cross the date line by using a minlongitude&lt;-180 or maxlongitude&gt;180.</small></p>
...
<h4>Circle</h4>
<p>Requests must include all of latitude, longitude, and maxradius to perform a circle search.</p>
<dl>
...
<dl>
	...
	<dd>Specify a magnitude type to use for testing the minimum and maximum limits.
		...
		<p>Examples:&ldquo;Md&rdquo;, &ldquo;Ml&rdquo;, &ldquo;Ms&rdquo;,
	...
	<dd>Specify if all origins for the event should be included, default is data center dependent but is suggested to be the preferred origin only.
		<br/><small>NOTE: because magnitudes and origins are strongly associated, this parameter is interchangable with includeallmagnitudes</small>
	</dd>

	<dt id="includeallmagnitudes">includeallmagnitudes</dt>
	<dd>Boolean "true"/"false".  Default false.</dd>
	<dd>Specify if all magnitudes for the event should be included, default is data center dependent but is suggested to be the preferred magnitude only.
		<br/><small>NOTE: because magnitudes and origins are strongly associated, this parameter is interchangable with includeallmagnitudes</small>
	</dd>
	...
	<dd>Select a specific event by ID; event identifiers are data center specific.
		<br/><small>NOTE: Selecting a specific event implies includeallorigins, includeallmagnitudes, and, additionally, associated moment tensor and focal-mechanisms are included.</small>
	</dd>

	<dt id="limit">limit</dt>
	<dd>Integer: [1,<?php echo $service->serviceLimit; ?>].  Default unlimited.</dd>
	<dd>Limit the results to the specified number of events.
		<br/><small>NOTE: The service limits queries to <?php echo $service->serviceLimit; ?>, and any that exceed this limit will generate a HTTP response code "400 Bad Request".</small>
	</dd>
	...
	<dd>Use the <a href="./catalogs">Catalogs Method</a> to find available catalogs.</dd>
	<dd>Limit to events from a specified catalog.
		<br/><small>NOTE: when catalog and contributor are omitted, the most preferred information from any catalog or contributor for the event is returned.</small>
	</dd>

	<dt id="contributor">contributor</dt>
	<dd>Use the <a href="./contributors">Contributors Method</a> to find available contributors.</dd>
	<dd>Limit to events contributed by a specified contributor.
		<br/><small>NOTE: when catalog and contributor are omitted, the most preferred information from any catalog or contributor for the event is returned.</small>
	</dd>
</dl>
...
<dl>
	...
	<dd>Specify the output format
		<dl>
			<dt>quakeml</dt>
			<dd>(Default) Response format is <a href="http://www.quakeml.org/">Quakeml 1.2</a>.  Mime-type is "application/xml".</dd>

			<dt>csv</dt>
			<dd>Response format is <a href="<?php echo $FEED_HOST . $FEED_PATH; ?>/csv.php">CSV</a>.  Mime-type is "text/csv".
			...
			<dt>kml</dt>
			<dd>Response format is <a href="<?php echo $FEED_PATH . $FEED_PATH; ?>/kml.php">KML</a>.  Mime-type is "vnd.google-earth.kml+xml".
				<dl>
					...
					<dd>
						Whether to include timestamp in generated kml, for google earth animation support.
	...
	<dd>Limit to events of a specific type.
		"earthquake" will filter non-earthquake events.
	</dd>

	<dt id="reviewstatus">reviewstatus</dt>
	<dd>Limit to events with a specific review status, default all.
		<dl>
			<dt>automatic</dt>
	...
	<dd>Decimal: [0,12]</dd>
	<dd>Minimum value for Maximum Modified Mercalli Intensity reported by ShakeMap.</dd>
	<dt id="maxmmi">maxmmi</dt>
	<dd>Decimal: [0,12]</dd>
	<dd>Maximum value for Maximum Modified Mercalli Intensity reported by ShakeMap.</dd>

	<dt id="mincdi">mincdi</dt>
	<dd>Decimal: [0,12]</dd>
	<dd>Minimum value for Maximum Community Determined Intensity reported by DYFI.</dd>
	<dt id="maxcdi">maxcdi</dt>
	<dd>Decimal: [0,12]</dd>
	<dd>Maximum value for Maximum Community Determined Intensity reported by DYFI.</dd>
	...
	<dd>Limit to events with a specific PAGER alert level, default all.
		<dl>
			<dt>green</dt>
	...
	<dd>Examples: "moment-tensor", "focal-mechanism", "shakemap", "losspager", "dyfi".</dd>
