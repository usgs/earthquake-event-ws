<?php
    ...
    $TEMPLATE = "twocolumn";
    $STYLESHEETS = "css/glossary.css";
    include_once($_SERVER["DOCUMENT_ROOT"] . "/template/template.inc.php");
?>

<section id="contents" class="column two">
	<h3>Event Terms</h3>
	<ul>
...
<dl class="typelist">
	...
	<dd>
		<dl>
			...
			<dd>
				...
				title="Did You Feel It?">DYFI</a>. While typically reported as a roman
				numeral, for the purposes of this API, intensity is expected as the
				<strong>decimal</strong> equivalent of the roman numeral. Learn more
				about <a
	...
	<dd>
		<dl>
			...
			<dd>
				...
				<a href="#ids">See the "ids" GeoJSON format property.</a>
			</dd>
		</dl>
	</dd>
	...
	<dd>
		<dl>
			...
			<dt>Description</dt>
			<dd>A comma-separated list of <a href="#id">event ids</a> that are associated to an event.</dd>
		</dl>
	</dd>
	...
	<dd>
		<dl>
			...
			<dd>
				...
				While typically reported as a roman numeral, for the purposes of this
				API, intensity is expected as the <strong>decimal</strong> equivalent
				of the roman numeral. Learn more about <a
				href="http://earthquake.usgs.gov/learn/topics/mag_vs_int.php"
				>magnitude vs. intensity</a>.
			</dd>
		</dl>
	...
	<dd>
		<dl>
			<dt>Data Type</dt><dd class="datatype">String</dd>
			<dt>Typical Values</dt><dd>&ldquo;earthquake&rdquo;, &ldquo;quarry&rdquo;</dd>
			<dt>Description</dt>
			<dd>
	...
	<dd>
		<dl>
			<dt>Data Type</dt><dd class="datatype">String</dd>
			<dt>Typical Values</dt><dd>",cap,dyfi,eq-location-map,general-link,geoserve,nearby-cities,origin,p-wave-travel-times,phase-data,scitech-link,tectonic-summary,"</dd>
			<dt>Description</dt>
			<dd>
...
<dl class="typelist">
	...
	<dd>
		<dl>
			<dt>Data Type</dt><dd class="datatype">String</dd>
			<dt>Typical Values</dt>
			<dd>"USGS Magnitude 1+ Earthquakes, Past Day", "USGS Magnitude 4.5+ Earthquakes, Past Month"</dd>
			<dt>Description</dt>
			<dd>
...
<dl class="typelist">
		...
		<dl>
			...
			<dd>
				...
				<dl>
					...
					<dt>&lt;path&gt;</dt>
					<dd>String relative path within this product, frequently a filename.</dd>
	...
	<dd>
		<dl>
			...
			<dd>
				...
				<dl>
					<dt>source</dt>
					<dd>The product contributor, usually a <a href="#net">network code</a>.</dd>
					...
					<dt>code</dt>
					<dd>
						A unique identifier from the product <code>source</code>, for this <code>type</code> of product.
					</dd>
	...
	<dd>
		<dl>
			...
			<dt>Description</dt>
			<dd>
				Products have zero or more key/value properties, which are both Strings.
				Properties vary depending on <a href="#product_id">product type</a>.
			</dd>
		</dl>
	</dd>
		...
		<dl>
			...
			<dd>
				...
				When multiple products of the same type are associated to an event,
					one product of each type is considered "most preferred".
				This is defined as the product of that type with the largest <code>preferredWeight</code>, and
					when two products have equal preferredWeight the most recent updateTime is more preferred.
			</dd>
		</dl>
	</dd>
	...
	<dd>
		<dl>
			...
			<dd>
				...
				There is only one reserved status <code>DELETE</code>, which indicates the product has been deleted.
				Any other value indicates a product update, and may vary depending on
